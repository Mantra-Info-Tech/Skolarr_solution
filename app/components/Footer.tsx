      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-[#a67c52] font-bold text-lg">Quick Links</h4>
          ...
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-[#a67c52] font-bold text-lg">Useful Links</h4>
            <ul className="space-y-4 text-gray-800 font-medium">
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="space-y-4">
              <h4 className="text-[#a67c52] font-bold text-lg">Contact Us</h4>
              <div className="text-gray-800 font-medium space-y-2">
                <p>0422-4370044</p>
                <p>+91 9514513331</p>
                <p className="break-all">info@skolarssolutions.com</p>
                <p className="break-all">skolarssolutions@gmail.com</p>
              </div>
            </div>

            <div className="space-y-4">
              <h4 className="text-[#a67c52] font-bold text-lg">Address</h4>
          ...
          {/* Column 5: Socials */}
          <div className="lg:col-span-2 space-y-6">
            <h4 className="text-[#a67c52] font-bold text-lg">Get in Touch</h4>
            <div className="flex items-center gap-4">
              <Link
                href="#"
                aria-label="Facebook"
                className="p-2 border border-gray-400 rounded-md hover:bg-[#a67c52] hover:text-white hover:border-[#a67c52] transition-all"
              >
                <Facebook size={20} />
              </Link>
              <Link
              ...
              >
                <svg
                  ...
                  className="text-[#141414] transition-colors group-hover:text-white"
                  fill="none"
                >
                  <path
